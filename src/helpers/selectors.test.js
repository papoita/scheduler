...
test("getInterviewsForDay returns an object with the interviewer data", () => {
  const result = getInterviewsForDay(state, state.appointments["3"].interview);
...
test("getInterviewsForDay returns null if no interview is booked", () => {
  const result = getInterviewsForDay(state, state.appointments["2"].interview);
